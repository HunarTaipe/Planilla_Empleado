...
namespace Ejemplo01
{
    public partial class Frm_empleados : Form
    {
        ...
        private void btnRegistrar_Click(object sender, EventArgs e)
        {
            ...
            int hijos = Convert.ToInt32( numHijos.Text);
            ...
            double Sueldobase = 0;
            if (condicion == "personal") Sueldobase = estaticSueldoPer;
            if (condicion == "comision") Sueldobase = estaticSueldoCom;
           ...
           double movilidadCOM = 1100*0.10;
            double Movilidad = 0;
            if (condicion == "personal") Movilidad = movilidadPER;
            if (condicion == "comision") Movilidad = movilidadCOM;


            //asignacion por numero de hijos
            int Xhijo = 20;
            int asignacion = Xhijo*hijos;
            ...
            //mostrra descuento en listview
            double Descuentos = 0;
            if (condicion == "personal") Descuentos = descuentoPER;
            if (condicion == "comision") Descuentos = descuentoCOM;

            //descuento del 17% segun tipo sueldo
            Double descuento = 0;
            if (condicion == "personal") descuento = personal - descuentoPER;
            if (condicion == "comision") descuento = comicion - descuentoCOM;

            //operacion para sacar el sueldo a cobrar neto 
            double Cobrarneto = 0;
            if (condicion == "personal") Cobrarneto = Sueldobase + Movilidad + asignacion - Descuentos;
            if (condicion == "comision") Cobrarneto = Sueldobase + Movilidad + asignacion - Descuentos;

            //llenando datos en lisview
            ListViewItem fila = new ListViewItem(empleado);
            fila.SubItems.Add(hijos.ToString("0"));
            fila.SubItems.Add(area);
            fila.SubItems.Add(condicion);
            fila.SubItems.Add(tiempoServ);
            fila.SubItems.Add(Sueldobase.ToString("0.0"));
            fila.SubItems.Add(Movilidad.ToString("0.0"));
            fila.SubItems.Add(asignacion.ToString("0"));
            fila.SubItems.Add(Descuentos.ToString("0"));
            fila.SubItems.Add(Cobrarneto.ToString("0.0"));
